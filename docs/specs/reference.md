...
| Fighter Squadrons (per colony)                 | Max FS = floor(Colony PU ÷ 100) × Fighter Doctrine multiplier (FD I = 1.0×, FD II = 1.5×, FD III = 2.0×). 2-turn grace on capacity violation → auto-disband excess. | [2.4.1](assets.md#241-fighter-squadrons-carriers)          |
