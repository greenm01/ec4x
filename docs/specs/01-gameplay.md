...
**House Valerian**
The Valerian dynasty measures its age not in generations but in stellar epochs. When the First Expansion pushed humanity beyond the core systems, it was a Valerian who planted the first flag on a world orbiting another star — a fact their archivists have never allowed anyone to forget. Their ancestral seat orbits a dying red giant, a calculated choice made by the founders: every heir who gazes upon that swelling, cooling star is reminded that nothing lasts forever except the will to endure. They are the oldest of the *dynatoi*. The other houses know it. So do they.

**House Thelon**
The Thelon rose to prominence not through conquest or discovery, but through something rarer and more durable: patience. During the Collapse Wars, when every other house chose a side and bled for it, the Thelon chose all of them — supplying, informing, and quietly profiting while the great fleets destroyed one another. Their motto translates loosely as *patience cuts deeper than blades*. The other houses have never forgiven them for being right. They call Thelon treacherous in the same breath they call them indispensable, and the Thelon have long understood that this contradiction is the source of all their power.

**House Marius**
There is an old saying in the officer academies: a Marius never asks permission to fight, only where. The dynasty has produced more fleet admirals than any other house in the empire — not by accident, but by design. Command is earned through the duel, not inherited through appointment. Their war college draws candidates from across known space, and graduates who wash out still outperform the best officers most houses can field. They do not merely study war. They have made war into a civilization.

**House Kalan**
Wealth, the Kalan founders understood, is not gold or ships or colonies. Wealth is the thing others cannot do without. Three centuries ago, Kalan prospectors surveying what every other house had dismissed as worthless rock discovered the rare-earth deposits that power every drive coil, every weapons array, every communications relay in the empire. They have been careful never to extract too much, never to let prices fall, never to let a rival develop a substitute. Every marriage contract includes financial clauses that will still be generating revenue when the grandchildren of the signatories are dust. The other houses call this greed. The Kalan call it foresight.

**House Delos**
The Delos Traverse — that improbable chain of stable jump points threading through the Periphery — was not discovered by accident. It was found by their founder, a scientist-explorer who spent eleven years mapping gravitational anomalies that every other navigator had discarded as noise. The empire was built on that route, and House Delos has never let it forget the debt. Technology is not merely a tool to House Delos; it is a theology. They regard the other houses with a detached, almost clinical pity — powerful in the way that blunt instruments are powerful, incapable of the precision that separates civilization from mere survival.

**House Stratos**
Three houses no longer exist because of the Stratos. Not destroyed in battle — absorbed, dissolved, their lineages folded into Stratos through a combination of strategic marriage and, when patience ran out, swift military action. They celebrate Incorporation Day each year with a feast that the surviving *dynatoi* attend and pretend to enjoy. Their expansion model is simple: identify a weaker neighbor, cultivate dependency, then offer a merger that is more politely worded than an ultimatum but functionally indistinguishable from one. The empire considers them aggressive. They consider themselves efficient.

**House Nikos**
No house has torn itself apart as many times as Nikos and still held its borders. The family tree splits at nearly every generation into rival branches, and the arguments over succession have twice erupted into open civil war that the other houses watched with poorly concealed delight. Both times, they survived. The historians explain this as stubbornness. Nikos strategists describe it differently: when a Nikos is threatened from outside, the internal factions stop fighting each other with a speed that has surprised more than one invader. Eight centuries of core territory, intact. The price was high, but the account remains open.

**House Hektor**
The Hektor homeworld is a cautionary tale taught in every colonial engineering program in the empire. Three hundred years ago, the industrial ambition of the Hektor ancestors outpaced their caution, and the cascading ecological collapse that followed rendered an entire planet uninhabitable within a single generation. The diaspora scattered across seven systems, carrying nothing but memory and the burning need to rebuild. That wound has never closed. Hektor gatherings are quiet, deliberate affairs, heavy with a shared understanding of what was lost and what must never be risked again. Some houses see tragedy in this. The Hektor see clarity. They know precisely what is worth protecting — because they have already lost it once.

**House Krios**
The core-world houses still tell the story with a mixture of amusement and discomfort: a convoy of underfunded frontier colonists, turned away from every catalogued system, pushed deeper into unmapped space out of desperation — and found paradise. Not once, but four times. The habitable worlds that built the Krios fortune were sitting in sectors that three major survey expeditions had written off as barren. The Krios have never quite forgiven the core houses for their condescension, and they have never quite stopped enjoying the look on their faces when they need something only the Krios can provide. The frontier made them, and they see no reason to pretend otherwise.

**House Zenos**
Every generation, one member of the Zenos bloodline is designated Philosopher-Heir and given a single mandate: observe everything, write it down, and make it mean something. The resulting texts — part history, part strategic doctrine, part philosophy — are studied in academies across the empire, and have shaped military thinking for two centuries in ways that most commanders cannot trace back to their source. This is power of a particular kind: invisible, deniable, and almost impossible to destroy. Their fleets are modest. Their armies are adequate. But the frameworks through which their rivals understand the galaxy were, in significant part, written by Zenos ancestors. They find this deeply satisfying.

**House Theron**
Five times in three centuries, an invading force has crossed into Theron space expecting a short campaign. Five times, they encountered the same maddening response: no decisive engagement, no fixed front, just a slow grinding retreat that traded territory for time while supply lines stretched thin and casualty lists grew longer than any pre-war estimate had projected. Five times, the invader eventually stopped. Their commanders are called cautious by rivals who confuse aggression with competence. What they practice is something more precise — an understanding that space is not a weakness to yield, but a weapon to deploy. The patient mind, their doctrine holds, wins the war that the impatient mind wins on paper.

**House Alexos**
Three generations ago, a marriage alliance elevated what had been a prosperous but minor clan into the ranks of the great houses. The ceremony was lavish. The congratulations from the older *dynatoi* were gracious. The tone behind both has never quite changed. The Alexos have spent three generations proving that their elevation was earned and not merely granted, and the oldest houses have spent three generations making sure the standard of proof keeps rising. It has made them formidable in ways their critics did not anticipate. There is no more dangerous rival than one who has spent their entire existence being told they do not belong.
