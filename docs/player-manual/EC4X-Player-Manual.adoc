...
image::images/logistic_population_growth.png[Logistic Population Growth]
...
image::images/pu_to_ptu.png)[PU to PTU Relationship] 
image::mages/ptu_to_pu.png)[PTU to PU Relationship] 
