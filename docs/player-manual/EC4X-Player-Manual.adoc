...
*Military Research Points (MRP)*: Advances weapons (WEP) and construction (CST) technologies. WEP improvements increase ship combat effectiveness. CST improvements increase facility construction capacity and unlock advanced hull classes.
...
[cols="^,<,^,^", options="header"]
|===
| Tech Level | Prerequisites | MRP Cost | ML Required
...
[cols="^,<,^,^,^", options="header"]
|===
| Tech Level | Prerequisites | MRP Cost | ML Required | CR Increase
...
| MRP | Military Research Points – used to purchase specific technologies | <<41-research-points-rp,4.1>>
