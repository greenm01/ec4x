...
* SB (starbases)
* GND (ground units: armies + marines)
* GB (ground batteries)
...
FLT:    width=3   align=right  truncate=none
SB:     width=3   align=right  truncate=none
GND:    width=3   align=right  truncate=none
GB:     width=3   align=right  truncate=none
...
----
┌──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│SYSTEM            │SECTR│CLASS│RES  │ POP │ IU  │ GCO │ NCV │GROWTH│CD │RD │FLT│SB │GND│GB │SLD│STATUS                │
├──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│Caladan           │ A01 │BEN  │RIC  │ 120 │  80 │  400│  220│  +1.2│ 10│  8│  2│ 1 │ 20│ 5 │ Y │OK                    │
│Arrakis           │ C03 │HAR  │ABD  │  60 │  40 │  180│   96│  +0.6│  6│  4│  5│ 0 │  0│ 2 │ N │CN, TF                │
│Ix                │ B09 │LUS  │RIC  │  90 │  70 │  320│  180│  +0.9│  8│  6│  0│ 1 │  5│ 2 │ Y │BLK, CAP, DMG         │
└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
----
