...
function HEX3Aanonymous__qbpunpx_u65(event_p0) {
    ...
    Label1: {
      ...
      Label2: {
          ...
          if (!(i_553649360 < L_553649361)) break Label3;
            ...
            Temporary4 = HEX3Aanonymous__qbpunpx_u65.bind(null); Temporary4.ClP_0 = HEX3Aanonymous__qbpunpx_u65; Temporary4.ClE_0 = null;
...
function isWhitespace__qbpunpx_u408(x_p0) {
...
function toToc__qbpunpx_u411(x_p0, father_p1) {
                var Temporary5;
            var Temporary6;
            var Temporary7;
            var Temporary8;
    ...
    Label1: {
        ...
        if (!(i_553648550 < x_p0.childNodes.length)) break Label2;
          ...
          Label3: {
              Label4: while (true) {
                if (!(nxt_553648551 < x_p0.childNodes.length)) Temporary5 = false; else {                  Temporary5 = isWhitespace__qbpunpx_u408(x_p0.childNodes[nxt_553648551]);                }              if (!Temporary5) break Label4;
          ...
          Label9: {
            ...
            Label10: {
                ...
                if (!(i_553649376 < colontmp__553649375)) break Label11;
                  ...
                  toToc__qbpunpx_u411(it_553648565.childNodes[j_553648570], e_553648564);
          ...
          i_553648550 = addInt(nxt_553648551, 1);
            ...
            toToc__qbpunpx_u411(x_p0.childNodes[i_553648550], f_553648549);
    ...
    if (isWhitespace__qbpunpx_u408(x_p0)) {
    }
    else {
    if ((x_p0.nodeName == "LI")) {
    var idx_553648588 = [];
    Label12: {
      ...
      Label13: {
          ...
          if (!(i_553649380 < colontmp__553649379)) break Label14;
            ...
            if (!(isWhitespace__qbpunpx_u408(x_p0.childNodes[i_553648593]))) {
    ...
    Label16: {
      ...
      Label17: {
          ...
          if (!(i_553649384 < colontmp__553649383)) break Label18;
            ...
            toToc__qbpunpx_u411(it_553648610.childNodes[j_553648615], e_553648609);
      ...
      Label19: {
        ...
        Label20: {
            ...
            if (!(i_553649388 < colontmp__553649387)) break Label21;
              ...
              toToc__qbpunpx_u411(x_p0.childNodes[i_553648624], father_p1);
...
function extractItems__qbpunpx_u199(x_p0, heading_p1, items_p2, items_p2_Idx) {
  BeforeRet: {
    if ((x_p0 == null)) {
    break BeforeRet;
    }
      ...
      Label4: {
        ...
        Label5: {
            ...
            if (!(i_553649396 < L_553649397)) break Label6;
              ...
              extractItems__qbpunpx_u199(k_553648373, heading_p1, items_p2, items_p2_Idx);
              i_553649396 += 1;
...
function tree__qbpunpx_u130(tag_p0, kids_p1) {
...
function text__qbpunpx_u155(s_p0) {
...
function uncovered__qbpunpx_u600(x_p0) {
    var Temporary1;
    ...
    Label2: {
      ...
      Label3: {
          ...
          if (!(i_553649416 < L_553649417)) break Label4;
            ...
            var y_553648746 = uncovered__qbpunpx_u600(k_553648745);
            if (!((y_553648746 == null))) {
...
function mergeTocs__qbpunpx_u630(orig_p0, news_p1) {
  var result_553648761 = null;

    result_553648761 = uncovered__qbpunpx_u600(orig_p0);
...
function buildToc__qbpunpx_u650(orig_p0, types_p1, procs_p2) {
  var result_553648782 = null;
            ...
            Label4: {
              ...
              Label5: {
                  ...
                  if (!(i_553649401 < L_553649402)) break Label6;
                    ...
                    var q_553648806 = tree__qbpunpx_u130("A", [text__qbpunpx_u155(p_553648800.title)]);
    ...
    result_553648782 = mergeTocs__qbpunpx_u630(orig_p0, newStuff_553648787);

  return result_553648782;

}

function add__qbpunpx_u148(parent_p0, kid_p1) {
...
function setClass__qbpunpx_u152(e_p0, value_p1) {
    e_p0.setAttribute("class", value_p1);

  
}

function toHtml__qbpunpx_u278(x_p0, isRoot_p1) {
    var Temporary1;

function HEX3Aanonymous__qbpunpx_u298(a_p0, b_p1) {
  ...
  BeforeRet: {
    ...
    result_553648409 = tree__qbpunpx_u130("DIV", []);
    if ((!((x_p0.heading == null)) && !(x_p0.heading.hasOwnProperty('__karaxMarker__')))) {
    add__qbpunpx_u148(result_553648409, x_p0.heading.cloneNode(true));
    }
    
    var ul_553648425 = tree__qbpunpx_u130("UL", []);
    if (isRoot_p1) {
    setClass__qbpunpx_u152(ul_553648425, "simple simple-toc");
    }
    else {
    setClass__qbpunpx_u152(ul_553648425, "simple");
    }
    
    if (x_p0.doSort) {
    Temporary1 = HEX3Aanonymous__qbpunpx_u298.bind(null); Temporary1.ClP_0 = HEX3Aanonymous__qbpunpx_u298; Temporary1.ClE_0 = null;
    ...
    Label2: {
      ...
      Label3: {
          ...
          if (!(i_553649420 < L_553649421)) break Label4;
            ...
            var y_553648452 = toHtml__qbpunpx_u278(k_553648451, false);
            if (!((y_553648452 == null))) {
            add__qbpunpx_u148(ul_553648425, tree__qbpunpx_u130("LI", [y_553648452]));
            }
    ...
    add__qbpunpx_u148(result_553648409, ul_553648425);
    }
...
function replaceById__qbpunpx_u158(id_p0, newTree_p1) {
...
function togglevis__qbpunpx_u708(d_p0) {
...
function groupBy(value_p0) {
    ...
    toToc__qbpunpx_u411(toc_553648840, tt_553648848);
    tt_553648848 = tt_553648848.kids[chckIndx(0, 0, (tt_553648848.kids).length - 1)];
    var types_553648853 = [[]];
    var procs_553648858 = [[]];
    extractItems__qbpunpx_u199(tt_553648848, "Types", types_553648853, 0);
    extractItems__qbpunpx_u199(tt_553648848, "Procs", procs_553648858, 0);
    extractItems__qbpunpx_u199(tt_553648848, "Converters", procs_553648858, 0);
    extractItems__qbpunpx_u199(tt_553648848, "Methods", procs_553648858, 0);
    extractItems__qbpunpx_u199(tt_553648848, "Templates", procs_553648858, 0);
    extractItems__qbpunpx_u199(tt_553648848, "Macros", procs_553648858, 0);
    extractItems__qbpunpx_u199(tt_553648848, "Iterators", procs_553648858, 0);
    var ntoc_553648859 = buildToc__qbpunpx_u650(tt_553648848, types_553648853[0], procs_553648858[0]);
    var x_553648860 = toHtml__qbpunpx_u278(ntoc_553648859, true);
    alternative_553648835[0] = tree__qbpunpx_u130("DIV", [x_553648860]);
    }
    
    if ((value_p0 == "type")) {
    replaceById__qbpunpx_u158("tocRoot", alternative_553648835[0]);
    }
    else {
    replaceById__qbpunpx_u158("tocRoot", tree__qbpunpx_u130("DIV", []));
    }
    
    togglevis__qbpunpx_u708(document.getElementById("toc-list"));
...
async function loadIndex__qbpunpx_u928() {
  var result_553649058 = null;

  BeforeRet: {
    var indexURL_553649064 = document.getElementById("indexLink").getAttribute("href");
    var rootURL_553649090 = HEX5BHEX5D__cherZfgehgvyf_u1307(cstrToNimstr(indexURL_553649064), HEX2EHEX2E__fgqZrahzhgvyf_u105(0, 14));
...
function then__qbpunpx_u1107(future_p0, onSuccess_p1, onReject_p2) {
...
function fuzzyMatch__shmmlfrnepu_u16(pattern_p0, str_p1) {
              var Temporary4;
              var Temporary5;
                var Temporary6;
      var Temporary7;
...
function escapeCString__qbpunpx_u751(x_p0, x_p0_Idx) {
    var s_553648881 = [];
    Label1: {
      var c_553648882 = 0;
...
function dosearch__qbpunpx_u755(value_p0) {
    var Temporary5;

function HEX3Aanonymous__qbpunpx_u783(a_p0, b_p1) {
  ...
  BeforeRet: {
    ...
    var ul_553648889 = tree__qbpunpx_u130("UL", []);
    result_553648885 = tree__qbpunpx_u130("DIV", []);
    setClass__qbpunpx_u152(result_553648885, "search_results");
      ...
      Label2: {
          ...
          if (!(i_553649435 < colontmp__553649434)) break Label3;
            ...
            Label4: {
              ...
              var tmpTuple_553648904 = fuzzyMatch__shmmlfrnepu_u16(value_p0, c_553648903);
    ...
    Temporary5 = HEX3Aanonymous__qbpunpx_u783.bind(null); Temporary5.ClP_0 = HEX3Aanonymous__qbpunpx_u783; Temporary5.ClE_0 = null;
    ...
    Label6: {
      ...
      Label7: {
          ...
          if (!(i_553649439 < colontmp__553649438)) break Label8;
            ...
            escapeCString__qbpunpx_u751(matches_553648894[chckIndx(i_553648941, 0, (matches_553648894).length - 1)]["Field0"], "innerHTML");
            add__qbpunpx_u148(ul_553648889, tree__qbpunpx_u130("LI", [matches_553648894[chckIndx(i_553648941, 0, (matches_553648894).length - 1)]["Field0"]]));
            i_553649439 = addInt(i_553649439, 1);
          }
      };
    };
    if ((ul_553648889.childNodes.length == 0)) {
    add__qbpunpx_u148(result_553648885, tree__qbpunpx_u130("B", [text__qbpunpx_u155("no search results")]));
    }
    else {
      add__qbpunpx_u148(result_553648885, tree__qbpunpx_u130("B", [text__qbpunpx_u155("search results")]));
      add__qbpunpx_u148(result_553648885, ul_553648889);
    }
...
function hideSearch__qbpunpx_u1090() {
    if (!((oldtoc_553649214[0] == null))) {
    replaceById__qbpunpx_u158("tocRoot", oldtoc_553649214[0]);
    }
...
function runSearch__qbpunpx_u1094() {
    ...
    var results_553649228 = dosearch__qbpunpx_u755(value_553649224);
    replaceById__qbpunpx_u158("tocRoot", results_553649228);
    }
    else {
    hideSearch__qbpunpx_u1090();
    }
...
function search() {
    ...
    loadIndexFut_553649217[0] = loadIndex__qbpunpx_u928();
    (then__qbpunpx_u1107(loadIndexFut_553649217[0], runSearch__qbpunpx_u1094, null));
    }
    ...
    Temporary1 = runSearch__qbpunpx_u1094.bind(null); Temporary1.ClP_0 = runSearch__qbpunpx_u1094; Temporary1.ClE_0 = null;
...
function HEX3Aanonymous__qbpunpx_u1175(e_p0) {
    if ((e_p0.key == "/")) {
    e_p0.preventDefault();
...
function HEX3Aanonymous__qbpunpx_u1210(e_p0) {
    hideSearch__qbpunpx_u1090();
...
Temporary2 = HEX3Aanonymous__qbpunpx_u1175.bind(null); Temporary2.ClP_0 = HEX3Aanonymous__qbpunpx_u1175; Temporary2.ClE_0 = null;
window.addEventListener("keypress", Temporary2, false);
Temporary3 = HEX3Aanonymous__qbpunpx_u1210.bind(null); Temporary3.ClP_0 = HEX3Aanonymous__qbpunpx_u1210; Temporary3.ClE_0 = null;
