...
proc saveDiagnosticMetrics*(db: DbConn, metrics: DiagnosticMetrics) =
  ...
  db.exec(
    ...
    INSERT OR REPLACE INTO diagnostic_metrics (
      ...
      destroyer_ships, light_cruiser_ships, cruiser_ships,
  ...
  """,
    ...
    metrics.dishonoredStatusActive.int,
    ...
    metrics.squadronLimitViolation.int,
    metrics.starbasesActual,
    metrics.autopilotActive.int,
    metrics.defensiveCollapseActive.int,
    ...
    metrics.clkResearchedNoRaiders.int,
    metrics.scoutCount,
    ...
    metrics.totalOrders,
    metrics.fleetCommandsSubmitted,
    metrics.buildOrdersSubmitted,
    metrics.colonizeOrdersSubmitted,
