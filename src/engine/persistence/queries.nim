...
proc getFleetsByHouse*(db: DbConn, gameId: int64, houseId: string,
                       turn: int): seq[Row] =
...
proc getOrderExecutionStats*(db: DbConn, gameId: int64,
                            orderType: string): Table[string, int] =
...
proc getEventsByType*(db: DbConn, gameId: int64,
                     eventType: string): seq[Row] =
...
proc getDiagnosticsByTurn*(db: DbConn, gameId: int64,
                          turn: int): seq[Row] =
