...
proc sabotageConducted*(
  ...
  let opType = case sabotageType
    ...
    else: EspionageAction.SabotageLow # Default
...
proc spyMissionDetected*(
  ...
  let opType = case missionType
    of "Sabotage": EspionageAction.SabotageLow # Generic for detection
    of "Tech Theft": EspionageAction.TechTheft
    else: EspionageAction.IntelligenceTheft
