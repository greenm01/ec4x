...
import commissioning, military, economic, orders, intelligence, victory,
  prestige, diplomatic, alerts, fleet_ops

export commissioning, military, economic, orders, intelligence, victory,
  prestige, diplomatic, alerts, fleet_ops
