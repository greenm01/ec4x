## Spy System Order Execution
##
## This module contains the logic for executing the 'Spy on a System' fleet order,
## which dispatches scout fleets to gather intelligence on all fleet activity in a system.
...
proc executeSpySystemOrder*(
  ...
  ## Order 12: Deploy scout for system reconnaissance
  ...
  updatedFleet.missionType = some(ord(orders.SpyMissionType.SpyOnSystem)) # Use orders.SpyMissionType
