## Ground Combat and Planetary Bombardment Mechanics
##
## This module implements planetary bombardment, invasion, and blitz operations.
## It encapsulates all ground combat-related types and logic.
##
...
proc conductBlitz*(
  ...
  ## 1. One round vs ground batteries (transports vulnerable)
