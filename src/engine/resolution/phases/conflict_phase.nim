  ...
  for fleetId, mission in state.activeSpyMissions.pairs:
    ...
    if detectionResult.detected:
      ...
      state.scoutLossEvents.add(intel_types.ScoutLossEvent(
        turn: state.turn,
        attacker: mission.ownerHouse,
        defender: defender,
        systemId: targetSystem,
        scoutsLost: mission.scoutCount
      ))
      ...
      of SpyMissionType.SpyOnPlanet:
        let intelReport = espionage_intel.generateColonyIntelReport(state, mission.ownerHouse, targetSystem, intel_types.IntelQuality.Perfect)
      ...
      of SpyMissionType.SpyOnSystem:
        let systemIntel = espionage_intel.generateSystemIntelReport(state, mission.ownerHouse, targetSystem, intel_types.IntelQuality.Perfect)
