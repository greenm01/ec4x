...
proc resolveProductionPhase*(
  ...
  logInfo(
    ...
    "[PRODUCTION STEP 1a] Activating orders (active + standing)...",
  )
  ...
  logInfo(
    LogCategory.lcOrders,
    &"[PRODUCTION STEP 1a] Order activation complete ({state.fleetCommands.len} total orders)",
  )
  ...
  logInfo(LogCategory.lcOrders, "[PRODUCTION STEP 1b] Performing order maintenance...")
  fleet_order_execution.performCommandMaintenance(
    ...
    "Production Phase - Fleet Movement",
  )
  logInfo(
    LogCategory.lcOrders,
    "[PRODUCTION STEP 1b] Order maintenance complete",
  )
  ...
  logInfo(
    LogCategory.lcOrders,
    &"[PRODUCTION STEP 1c] Moving fleets toward order targets... ({state.fleetCommands.len} persistent orders)",
  )
